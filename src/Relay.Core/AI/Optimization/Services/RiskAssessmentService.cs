...
public class RiskAssessmentService
{
    ...
    /// <summary>
    /// Performs detailed risk assessment including risk factors and mitigation strategies
    /// </summary>
    public RiskAssessment AssessOptimizationRiskDetailed(
        OptimizationStrategy strategy,
        RequestAnalysisData analysisData,
        Dictionary<string, double> systemMetrics)
    {
        ...
        return new RiskAssessment
        {
            ...
            AssessmentConfidence = adjustedConfidence,
