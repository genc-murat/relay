...
{
    /// <summary>
    /// Validation rule that checks if a string is a valid ISO 3166 country code.
    /// Supports both 2-letter and 3-letter country codes.
    /// </summary>
    public class CountryCodeValidationRule : IValidationRule<string>
    {
        private static readonly HashSet<string> ValidCountryCodes = new HashSet<string>
        {
            ...
            // ISO 3166-1 alpha-3 (3-letter codes) - subset
            ...
            "NIU", "NFK", "MNP", "NOR", "OMN", "PAK", "PLW", "PSE", "PAN", "PNG",
            ...
            "SWZ", "SWE", "CHE", "SYR", "TWN", "TJK", "TZA", "THA", "TLS", "TGO",
        ...
        public ValueTask<IEnumerable<string>> ValidateAsync(string request, CancellationToken cancellationToken = default)
        {
            ...
            if ((code.Length != 2 && code.Length != 3) || !ValidCountryCodes.Contains(code))
            {
                return new ValueTask<IEnumerable<string>>(new[] { "Invalid ISO 3166 country code." });
            }
