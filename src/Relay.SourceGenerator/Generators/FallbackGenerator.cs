...
public static class FallbackGenerator
{
    ...
    public static string GenerateBasicAddRelay(GenerationOptions options)
    {
        ...
        sb.AppendLine("// No handlers found");
        sb.AppendLine();
        ...
        if (options.IncludeDocumentation)
        {
            ...
            sb.AppendLine("    /// Generated when no handlers are found.");
            sb.AppendLine("    /// </summary>");
        }

        sb.AppendLine("    public static class GeneratedRelayExtensions");
        sb.AppendLine("    {");

        if (options.IncludeDocumentation)
        {
            sb.AppendLine("        /// <summary>");
            sb.AppendLine("        /// Registers basic Relay services with the DI container (no handlers found).");
            sb.AppendLine("        /// </summary>");
            sb.AppendLine("        /// <param name=\"services\">The service collection.</param>");
            sb.AppendLine("        /// <returns>The service collection for chaining.</returns>");
        }

        sb.AppendLine("        public static IServiceCollection AddRelayGenerated(this IServiceCollection services)");
        sb.AppendLine("        {");
