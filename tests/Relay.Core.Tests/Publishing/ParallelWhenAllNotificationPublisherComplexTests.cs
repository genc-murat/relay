...
{
    public class ParallelWhenAllNotificationPublisherComplexTests
    {
        ...
        public class ThrowingHandler : INotificationHandler<TestNotification>
        {
            ...
            {
                Handler1.ExecutionLog.Add($"ThrowingHandler: {notification.Message}");
        ...
        [Fact]
        public async Task PublishAsync_WithContinueOnException_ContinuesDespiteExceptions()
        {
            // Arrange
            Handler1.ExecutionLog.Clear();
            var publisher = new ParallelWhenAllNotificationPublisher(continueOnException: true);
            ...
            // All handlers should have executed despite exception
            Assert.Contains(Handler1.ExecutionLog, x => x.Contains("Handler1-Start"));
            Assert.Contains(Handler1.ExecutionLog, x => x.Contains("ThrowingHandler"));
            Assert.Contains(Handler1.ExecutionLog, x => x.Contains("Handler2-Start"));
        }
    }
}