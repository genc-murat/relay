...
{
    public class ParallelWhenAllNotificationPublisherLoggingTests
    {
        #region Test Models
        ...
        public async Task PublishAsync_WithLogger_LogsExecutionDetails()
        {
            ...
            var publisher = new ParallelWhenAllNotificationPublisher(continueOnException: true, mockLogger.Object);
