...
{
    public class SequentialNotificationPublisherExecutionModeTests
    {
        ...
        [Fact]
        public async Task PublishAsync_ExecutesHandlersInSequentialOrder()
        {
            // Arrange
            ...
            // Handlers should execute sequentially - Handler1 completes before Handler2 starts
