...
/// <summary>
/// Integration tests for AWS SQS/SNS message broker functionality
/// </summary>
[Trait("Category", "AwsSqsSns")]
public class AwsSqsSnsIntegrationTests : IDisposable
{
    ...
    public AwsSqsSnsIntegrationTests(ITestOutputHelper output)
    {
        _output = output;
    ...
    private IMessageBroker CreateBroker()
    {
        ...
        // In a real scenario, this would be the actual AwsSqsSnsMessageBroker
